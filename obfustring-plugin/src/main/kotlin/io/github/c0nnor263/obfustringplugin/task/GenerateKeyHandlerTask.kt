...
package io.github.c0nnor263.obfustringplugin.task
...
abstract class GenerateKeyHandlerTask : DefaultTask() {
    ...
    fun action() {
        ...
        println("PATH: ${output.get().asFile.absolutePath}")
    }

    companion object {
        const val NAME = "generateKeyHandlerTask"
    }
}